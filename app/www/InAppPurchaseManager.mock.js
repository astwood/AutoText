...
InAppPurchaseManager.prototype.makePurchase = function(productId, quantity) {
    ...
    cordova.exec(function() {
        if (productId == 'com.Astwood.AutoText.250credits') {
            me.onFailed('errno', 'errtext: error test message');
        } else {
            me.onPurchased('transactionIdentifier', productId, 'transactionReceipt');
        }
...
InAppPurchaseManager.prototype.requestProductData = function(productId, successCallback, failCallback) {
    ...
    }, failCallback, "InAppPurchaseManager", "requestProductData", [productId]);
};
